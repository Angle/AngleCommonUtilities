...
namespace Angle\Common\Utilities\Random;
/*
 * ADAPTED FROM: https://defuse.ca/generating-random-passwords.htm
...
class Random
{
    ## ADAPTED FUNCTION FOR NON-CLASHING UNBIASED RANDOM STRINGS
